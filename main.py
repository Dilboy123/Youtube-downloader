...
label1 = tk.Label(root, text='Zuuli Downloader 🎥', bg=BACKGROUND_COLOR)
...
def get_details():
    ...
    label4 = tk.Label(root, text=f"Title :  {new_string}", font=('helvetica', 20, 'bold'), bg=BACKGROUND_COLOR)
...
button1 = tk.Button(text='Get Details', command=get_details, fg='white',
                    font=buttonFont, highlightbackground=BACKGROUND_COLOR)
canvas1.create_window(200, 230, window=button1)

button2 = tk.Button(text='Download Video', command=download_video, fg='white',
                    font=buttonFont, highlightbackground=BACKGROUND_COLOR)
canvas1.create_window(400, 230, window=button2)

button3 = tk.Button(text='Download MP3', command=download_mp3, fg='white',
                    font=buttonFont, highlightbackground=BACKGROUND_COLOR)
canvas1.create_window(600, 230, window=button3)
